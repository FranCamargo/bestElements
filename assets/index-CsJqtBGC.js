...
render('7')`},"curadoria-button":{html:`<div class="demo-button">
...
})`},"curadoria-toggle":{html:`<div class="demo-toggle">
...
refresh()`},"curadoria-line-graph":{html:`<section class="demo-line">
  <div class="demo-controls">
    <button type="button" data-period="7">7 dias</button>
    <button type="button" data-period="15">15 dias</button>
    <button type="button" data-period="30">30 dias</button>
...
render('7')`},"curadoria-progress-bar":{html:`<section class="demo-progress">
...
render(Number(range.value))`},"curadoria-table-list":{html:`<section class="demo-table">
  <div class="demo-controls">
...
render()`},"curadoria-datatable-simples":{html:`<section class="demo-datatable">
...
render()`},"curadoria-modal-chatbot":{html:`<section class="demo-chatbot">
...
render()`},"curadoria-magic-cube":{html:`<section class="demo-magic-cube">
  <div class="scene">
...
// Exemplo R: ciclo de 4 cantos + 4 arestas e atualizacao de orientacao nas pecas afetadas.`},"curadoria-orbit-loader":{html:`<div class="demo-orbit-loader">
  <div class="core"></div>
  <div class="ring a"><span></span></div>
  <div class="ring b"><span></span></div>
  <div class="ring c"><span></span></div>
</div>`,css:`.demo-orbit-loader {
  position: relative;
  width: 170px;
  height: 170px;
  display: grid;
...
}`,ts:`// Loader automatico: animacao 100% em CSS com 3 orbitas.`},"curadoria-gooey-loader":{html:`<div class="demo-gooey-loader">
  <span></span><span></span><span></span><span></span><span></span>
</div>`,css:`.demo-gooey-loader {
  display: flex;
  gap: 10px;
  filter: blur(0.5px);
}
...
}`,ts:`// Loader automatico: bolhas em fase com delay sequencial.`},"curadoria-rocket-loader":{html:`<div class="demo-rocket-loader">
...
}`,ts:`// Loader automatico: foguete com oscilacao e fumaca.`},"curadoria-candy-ring-loader":{html:`<div class="demo-candy-loader">
  <div class="ring"></div>
</div>`,css:`.demo-candy-loader {
  display: grid;
  place-items: center;
}
...
}`,ts:`// Loader automatico: anel colorido com rotacao continua.`},"curadoria-wave-bars-loader":{html:`<div class="demo-wave-bars">
  <span></span><span></span><span></span><span></span><span></span><span></span><span></span><span></span><span></span><span></span>
</div>`,css:`.demo-wave-bars {
  display: flex;
...
}`,ts:`// Loader automatico: barras em cascata formando onda.`},"curadoria-starfield-pattern":{html:`<div class="demo-starfield">
  <div class="layer back"></div>
  <div class="layer mid"></div>
  <div class="layer front"></div>
</div>`,css:`.demo-starfield {
  position: relative;
  width: 220px;
  height: 160px;
  overflow: hidden;
...
}`,ts:`// Padrao automatico com tres camadas de estrelas em parallax.`},"curadoria-gradient-river-pattern":{html:`<div class="demo-gradient-river">
  <span class="river-layer a"></span>
  <span class="river-layer b"></span>
  <span class="river-layer c"></span>
</div>`,css:`.demo-gradient-river {
  position: relative;
  width: 220px;
  height: 160px;
  overflow: hidden;
...
}`,ts:`// Padrao automatico com blobs de gradient em movimento continuo.`},"curadoria-fluid-water":{html:`<div class="water-preview">
  <div class="water-container">
    <div class="wave back"></div>
    <div class="water-body"></div>
    <div class="wave"></div>
  </div>
</div>`,css:`.water-preview {
  position: relative;
  width: 300px;
  height: 200px;
  overflow: hidden;
...
}`,ts:`// Padrao de agua com preenchimento gradual e ondas laterais.`},"velvet-command-button":{html:`<button class="velvet-command-btn">Deploy seguro</button>`,css:`.velvet-command-btn {
...
})`},"confetti-pop-button":{html:`<button class="confetti-pop-btn">Liberar confete</button>`,css:`.confetti-pop-btn {
  border: none;
  border-radius: 999px;
  min-height: 44px;
  padding: 0 20px;
...
})`},"ledger-confirm-checkbox":{html:`<label><input type="checkbox" /> Contrato revisado</label>`,css:`label {
  display: flex;
  align-items: center;
  gap: 10px;
  font-family: Arial, sans-serif;
...
})`},"doodle-checklist-board":{html:`<button class="doodle-task"><span>✓</span> Postar teaser</button>`,css:`.doodle-task {
...
tasks.forEach((task) => task.addEventListener('click', () => task.classList.toggle('is-done')))`},"aurora-weather-card":{html:`<article id="aurora-card" class="aurora-weather-card is-rain is-rainy">
...
</article>`,css:`.aurora-weather-card {
  position: relative;
  overflow: hidden;
  border-radius: 16px;
  padding: 16px;
...
applyScenario('rain')`},"pixel-forecast-card":{html:`<article class="pixel-forecast">PIXEL WEATHER</article>`,css:`.pixel-forecast {
  border: 3px solid #0f1029;
  background: #8de4ff;
  color: #101a36;
  font-family: 'Courier New', monospace;
}`,ts:`const forecast = ['22', '27', '20']
console.log('Forecast pixel:', forecast.join(' / '))`},"glass-alert-modal":{html:`<article class="glass-alert-modal"><h4>Confirmar exclusao?</h4></article>`,css:`.glass-alert-modal {
...
}`},"comic-quick-modal":{html:`<article class="comic-modal"><span>POW!</span><h4>Missao concluida!</h4></article>`,css:`.comic-modal {
...
})`},"sticky-notes-kanban":{html:`<section class="sticky-kanban"><div class="note">Card comparativo</div></section>`,css:`.sticky-kanban {
  display: grid;
  grid-template-columns: repeat(3, 1fr);
  gap: 10px;
}
...
notes.forEach((note) => note.addEventListener('click', () => note.classList.toggle('is-highlighted')))`},"prism-pulse-loader":{html:`<div class="prism-loader"><span></span></div>`,css:`.prism-loader span {
  width: 74px;
  height: 74px;
  border-radius: 50%;
...
}`,ts:`// Loader 100% CSS sem logica adicional.`},"cloud-drizzle-loader":{html:`<div class="cloud-loader"><div class="cloud"></div><div class="rain"></div></div>`,css:`.cloud {
  width: 90px;
  height: 34px;
  border-radius: 999px;
  background: #d9ecff;
}`,ts:`// Anime gotas com delays para ritmo natural.`},"sunrise-kpi-card":{html:`<article class="sunrise-kpi"><strong>68.4%</strong></article>`,css:`.sunrise-kpi {
  border-radius: 16px;
  padding: 16px;
  background: linear-gradient(165deg, #ff9c56, #ffdca3);
  color: #4a2208;
}`,ts:`const trend = '+5.2 p.p.'
console.log('Tendencia:', trend)`},"finance-snapshot-card":{html:`<article class="finance-snapshot"><strong>R$ 128.430</strong></article>`,css:`.finance-snapshot {
  border-radius: 16px;
  padding: 16px;
  background: linear-gradient(160deg, #122640, #1e4d72);
  color: #e9f6ff;
}`,ts:`const progress = 74
console.log('Meta mensal:', progress + '%')`},"team-status-card":{html:`<article class="team-status-card"><h4>Team Pulse</h4></article>`,css:`.team-status-card {
  border-radius: 14px;
  padding: 14px;
  border: 1px solid #d7e3ef;
  background: #ffffff;
}`,ts:`const squads = [82, 74, 91]
console.log('Capacidade por squad:', squads)`},"retro-music-player-card":{html:`<article class="retro-player"><strong>Neon Night Drive</strong></article>`,css:`.retro-player {
  border-radius: 16px;
  padding: 16px;
...
playButton?.addEventListener('click', () => {
  // Alternar play/pause
})`},"arcade-score-pill":{html:`<div class="pixel-sweeper-loader">
  <div class="pixel-worker"></div>
  <div class="pixel-broom"></div>
</div>`,css:`.pixel-sweeper-loader {
  width: 170px;
  height: 110px;
  position: relative;
...
// Ideal para estados de espera com identidade retro.`},"sketch-profile-card":{html:`<article class="sketch-profile"><strong>Your name</strong></article>`,css:`.sketch-profile {
  border: 2px dashed #222;
  border-radius: 14px;
  background: #fffdf4;
  padding: 16px;
}`,ts:`const profile = { name: 'Your name', role: 'UI Illustrator' }
console.log(profile)`},"morphing-action-fab":{html:`<button class="morphing-fab">+</button>`,css:`.morphing-fab {
  width: 54px;
  height: 54px;
  border-radius: 50%;
  border: none;
...
})`}}[e]??{html:`<section class="item-preview">
  <div class="component-mock">Preview do elemento</div>
</section>`,css:`.component-mock {
  border: 1px solid var(--border);
  border-radius: 12px;
  padding: 1rem;
}`,ts:`export function Preview() {
  return <div className="component-mock">Preview do elemento</div>
}`};return{...t,html:Ir(t.html,`html`),css:Ir(t.css,`css`)}};function Ni({item:e,isLiked:t}){let[n,r]=(0,x.useState)(null),[i,a]=(0,x.useState)(`html`),o=Mi(e.slug),s=async e=>{let t=o[e];try{await navigator.clipboard.writeText(t),r(e),window.setTimeout(()=>r(null),1300)}catch{r(null)}};return(0,j.jsx)(jr,{title:e.title,description:e.description,isLiked:t,children:(0,j.jsxs)(`div`,{className:`component-detail-layout`,children:[(0,j.jsx)(`div`,{className:`component-preview-col`,children:(0,j.jsxs)(`div`,{className:`component-live-preview`,children:[(0,j.jsx)(`h3`,{children:`Visual do componente`}),(0,j.jsx)(`div`,{className:`preview-pattern-stage`,children:(0,j.jsx)(`div`,{className:`preview-center-frame`,children:(0,j.jsx)(Lr,{slug:e.slug})})})]})}),(0,j.jsx)(`div`,{className:`component-code-col`,children:(0,j.jsx)(Pi,{activeTab:i,onTabChange:a,code:o[i],copied:n===i,onCopy:()=>s(i)})})]})})}function Pi({activeTab:e,onTabChange:t,code:n,copied:r,onCopy:i}){return(0,j.jsxs)(`section`,{className:`code-box`,children:[(0,j.jsxs)(`header`,{className:`code-box-head`,children:[(0,j.jsx)(`div`,{className:`code-tabs`,role:`tablist`,"aria-label":`Tipos de codigo`,children:[`html`,`css`,`ts`].map(n=>(0,j.jsx)(`button`,{type:`button`,className:`code-tab ${e===n?`is-active`:``}`,role:`tab`,"aria-selected":e===n,onClick:()=>t(n),children:n.toUpperCase()},n))}),(0,j.jsxs)(`button`,{type:`button`,className:`copy-btn`,onClick:i,children:[r?(0,j.jsx)(ar,{size:15}):(0,j.jsx)(or,{size:15}),r?`Copiado`:`Copiar`]})]}),(0,j.jsx)(`pre`,{children:(0,j.jsx)(`code`,{children:n})})]})}function Fi({item:e,isLiked:t,onToggleLike:n}){return(0,j.jsxs)(`article`,{className:`gallery-card`,children:[(0,j.jsx)(`div`,{className:`card-thumbnail card-thumbnail-clean`,children:(0,j.jsx)(`div`,{className:`card-preview-live`,"aria-hidden":`true`,children:(0,j.jsx)(`div`,{className:`preview-center-frame`,children:(0,j.jsx)(Lr,{slug:e.slug})})})}),(0,j.jsxs)(`div`,{className:`card-content`,children:[(0,j.jsx)(`span`,{className:`pill`,children:e.category}),(0,j.jsx)(`h2`,{children:e.title}),(0,j.jsx)(`p`,{children:e.subtitle}),(0,j.jsxs)(`div`,{className:`card-actions`,children:[(0,j.jsx)(`button`,{type:`button`,className:`like-button ${t?`is-liked`:``}`,onClick:()=>n(e.slug),"aria-label":t?`Remover dos favoritos`:`Marcar como favorito`,title:t?`favoritado`:`favorito`,children:(0,j.jsx)(sr,{size:17,fill:t?`currentColor`:`none`})}),(0,j.jsxs)(kn,{to:e.route,className:`details-link`,children:[`View`,(0,j.jsx)(pr,{size:17})]})]})]})]})}function Ii({items:e,likes:t,onToggleLike:n}){let[r,i]=(0,x.useState)(``),[a,o]=(0,x.useState)(!1),[s,c]=(0,x.useState)(!1),l=e=>e.normalize(`NFD`).replace(/[\u0300-\u036f]/g,``).toLowerCase().trim(),u=(0,x.useMemo)(()=>{let n=l(r);return e.filter(e=>{if(s&&!t[e.slug])return!1;if(!n)return!0;let r=l(e.title),i=l(e.category);return r.includes(n)||i.includes(n)}).sort((e,t)=>e.title.localeCompare(t.title,`pt-BR`,{sensitivity:`base`}))},[e,t,r,s]);return(0,j.jsxs)(`main`,{className:`app-shell`,children:[(0,j.jsxs)(`header`,{className:`hero-section`,children:[(0,j.jsx)(`p`,{className:`hero-kicker`,children:`Fran Camargo`}),(0,j.jsx)(`h1`,{children:`UI & Dashboard gallery`}),(0,j.jsx)(`p`,{className:`hero-signature`,children:`Curadoria de interfaces e componentes front-end desenvolvidos por mim, para você se inspirar e utilizar. Clique nos cards para ver detalhes e código-fonte.`})]}),(0,j.jsxs)(`div`,{className:`gallery-toolbar`,"aria-label":`Ferramentas da galeria`,children:[(0,j.jsxs)(`div`,{className:`hover-search ${a?`is-collapsed`:``}`,children:[(0,j.jsx)(`button`,{type:`button`,className:`hover-search-toggle`,"aria-label":a?`Abrir busca`:`Fechar busca`,onClick:()=>o(e=>!e),children:(0,j.jsx)(`span`,{className:`hover-search-icon`,"aria-hidden":`true`,children:(0,j.jsx)(`svg`,{viewBox:`0 0 24 24`,role:`presentation`,focusable:`false`,children:(0,j.jsx)(`path`,{d:`M10.5 3.5a7 7 0 1 0 4.45 12.4l4.33 4.33a1 1 0 0 0 1.42-1.42l-4.33-4.33A7 7 0 0 0 10.5 3.5Zm0 2a5 5 0 1 1 0 10a5 5 0 0 1 0-10Z`})})})}),(0,j.jsx)(`span`,{className:`sr-only`,children:`Pesquisar por nome ou tipo`}),(0,j.jsx)(`input`,{id:`gallery-search`,name:`gallery-search`,type:`search`,className:`hover-search-input`,placeholder:`Pesquisar por nome ou tipo`,"aria-label":`Pesquisar por nome ou tipo`,value:r,onChange:e=>i(e.target.value),disabled:a})]}),(0,j.jsx)(`button`,{type:`button`,className:`favorites-filter-button ${s?`is-active`:``}`,"aria-label":s?`Mostrar todos os itens da galeria`:`Mostrar apenas itens favoritados`,"aria-pressed":s,title:s?`Mostrando favoritados`:`Filtrar por favoritados`,onClick:()=>c(e=>!e),children:(0,j.jsx)(sr,{size:18,fill:s?`currentColor`:`none`})})]}),(0,j.jsxs)(`section`,{className:`gallery-grid`,"aria-label":`Galeria de elementos`,children:[u.map(e=>(0,j.jsx)(Fi,{item:e,isLiked:!!t[e.slug],onToggleLike:n},e.slug)),u.length===0?(0,j.jsx)(`p`,{className:`gallery-empty-inline`,"aria-live":`polite`,children:s?`Nenhum item favoritado encontrado${r?` para "${r}"`:``}.`:`Nenhum item encontrado para "${r}".`}):null]})]})}function Li(){let e=lt(),[t,n]=(0,x.useState)(()=>localStorage.getItem(`be-theme`)===`dark`?`dark`:`light`),[r,i]=(0,x.useState)(()=>{let e=sessionStorage.getItem(`be-favorites`);if(!e)return{};try{return JSON.parse(e)}catch{return{}}}),[a,o]=(0,x.useState)(!1);return(0,x.useEffect)(()=>{document.documentElement.setAttribute(`data-theme`,t),localStorage.setItem(`be-theme`,t)},[t]),(0,x.useEffect)(()=>{sessionStorage.setItem(`be-favorites`,JSON.stringify(r))},[r]),(0,x.useEffect)(()=>{let e=()=>{o(window.scrollY>8)};return e(),window.addEventListener(`scroll`,e,{passive:!0}),()=>{window.removeEventListener(`scroll`,e)}},[]),(0,j.jsxs)(j.Fragment,{children:[(0,j.jsx)(`header`,{className:`top-navigation ${a?`is-scrolled`:``}`,"aria-label":`Navegacao principal`,children:(0,j.jsxs)(`div`,{className:`top-navigation-inner`,children:[(0,j.jsxs)(`nav`,{className:`top-navigation-links`,"aria-label":`Atalhos principais`,children:[(0,j.jsx)(kn,{to:`/`,className:`nav-link ${e.pathname===`/`?`is-active`:``}`,children:`Home`}),(0,j.jsx)(kn,{to:`/sobre-mim`,className:`nav-link ${e.pathname===`/sobre-mim`?`is-active`:``}`,children:`Sobre mim`})]}),(0,j.jsx)(vr,{theme:t,onToggle:()=>{n(e=>e===`light`?`dark`:`light`)}})]})}),(0,j.jsxs)(Rt,{children:[(0,j.jsx)(It,{path:`/`,element:(0,j.jsx)(Ii,{items:yr,likes:r,onToggleLike:e=>{i(t=>({...t,[e]:!t[e]}))}})}),yr.map(e=>(0,j.jsx)(It,{path:e.route,element:(0,j.jsx)(Ni,{item:e,isLiked:!!r[e.slug]})},e.slug)),(0,j.jsx)(It,{path:`/sobre-mim`,element:(0,j.jsx)(Ar,{})})]})]})}(0,qn.createRoot)(document.getElementById(`root`)).render((0,j.jsx)(x.StrictMode,{children:(0,j.jsx)(En,{basename:`/bestElements/`,children:(0,j.jsx)(Li,{})})}));